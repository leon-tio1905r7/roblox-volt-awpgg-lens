#!/usr/bin/env python3
"""Roblox-volt-awp.gg screen analysis tool with overlay and hotkeys."""
import argparse
import logging
import threading
import time
...
class Robloxvoltawpgglens:
 ...
 def start(self):
 log.info("roblox-volt-awpgg-lens starting...")
 ...
 self.overlay.close()
 self.hotkeys.stop()
 log.info("roblox-volt-awpgg-lens stopped")
...
def main():
 ...
 app = Robloxvoltawpgglens(args.config)
 app.start()
